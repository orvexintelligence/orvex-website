...
if (canvas) {
  ...
  function resize() {
    ...
    camera.position.set(0, isMobile ? 1.2 : 1.4, isMobile ? 11.6 : 9.2);
    root.position.set(isMobile ? 0.16 : 2.45, isMobile ? -0.62 : 0.05, isMobile ? -1.42 : -0.8);
    root.scale.setScalar(isMobile ? 0.5 : 0.92);
