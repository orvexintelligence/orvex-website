...
if (canvas) {
  ...
  function resize() {
    ...
    camera.position.set(0, isMobile ? 1.08 : 1.4, isMobile ? 10.95 : 9.2);
    root.position.set(isMobile ? 0 : 2.45, isMobile ? -1.92 : 0.05, isMobile ? -1.42 : -0.8);
    root.scale.setScalar(isMobile ? 0.76 : 0.92);
